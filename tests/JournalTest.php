...
class JournalTest extends BaseTest
{
	...
	public function testJournalObjectReferences()
	{
		...
		*/
		...
		$this->assertInstanceOf($a_transaction->reference_type, $a_transaction->getReferencedObject());
		...
		// and also that the referenced product can be retrieved from the transaction
		$this->assertInstanceOf($u_transaction->reference_type, $u_transaction->getReferencedObject());
